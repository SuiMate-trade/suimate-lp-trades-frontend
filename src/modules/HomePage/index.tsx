...
const SampleTrader = {
  ...
  totalLiquiditySupplied: 62461237623789,
  totalRewardsClaimed: 9312304338956,
  lastTradedTimestamp: 1716395913305,
};

export default function HomePageModule() {
  const [topFilter, setTopFilter] = useState<OrderTradersBy>(
    "totalLiquiditySupplied"
  );
  const [dexFilter, setDexFilter] = useState<string>("All Protocols");
