...
export default class ApiService {
  static getTopLPTraders(data: { orderBy: string; limit: number }) {
  ...
  static getPoolsSupplied(address: string) {
    return axios.get(`${GET_POOLS_SUPPLIED_ENDPOINT}?address=${address}`);
  }
